...
const LevelTwo = () => {
    ...
    return (
        <div
            className="relative col-span-2 border bg-green-400 md:w-[502px] w-full md:h-[502px]"
        ...
        >
            ...
            <StopWatch setMarioSide={setMarioSide} setMarioCords={setMarioCords} time={time} setTime={setTime} />
            <MarioPlayer
                xaxis={marioCords.x}
                yaxis={marioCords.y}
                setTime={setTime}
